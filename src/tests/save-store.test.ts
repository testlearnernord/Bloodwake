...
describe('save serialization and validation', () => {
  ...
  it('serializes and reloads a save slot (v7)', async () => {
  ...
  it('exports and imports a valid v7 save payload', () => {
  ...
  it('rejects v7 saves with non-finite player vitae values', () => {
  ...
  it('rejects malformed inventory entries in v7 saves', () => {
  ...
  it('preserves turned vampire vassals across v7 save export and reload', () => {
  ...
  it('rejects v7 saves that still contain a legacy servants field', () => {
  ...
  it('rejects v7 saves that still contain a legacy hunger field with a targeted error', () => {
  ...
  it('rejects v7 saves with malformed humanServants records', () => {
  ...
  it('rejects v7 saves with malformed vampireVassals records', () => {
    const state = createNewGameState({ seed: 'malformed-vv' });
    const bad = { ...state, vampireVassals: [{ id: 'x', kind: 'wrong_kind' }] };
    expect(validateSaveGame(bad)).toBe(false);
  });

  it('rejects v7 saves with duplicate IDs within humanServants', () => {
  ...
  it('rejects v7 saves with duplicate IDs within vampireVassals', () => {
  ...
  it('rejects v7 saves with a shared ID across both population collections', () => {
  ...
  it('rejects malformed v7 Blood Resonance metadata', () => {
  ...
  it('rejects malformed v7 Resolve metadata', () => {
  ...
  it('rejects stale v7 free-human metadata fields', () => {
