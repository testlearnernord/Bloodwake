...
describe('0.6.3e save authority purge', () => {
  it('uses save v10 with one authority for construction, Blood Essence, and memories', () => {
  ...
  it('rejects stale v10 payloads that reintroduce removed duplicate authorities', () => {
